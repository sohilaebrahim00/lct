...
- [ ] AI Concierge: supply an OpenAI or Gemini API key and deploy `supabase/functions/ai-concierge` (no CLI auth or access token available in this environment — see §1c-39/§1c-41)  
